...
function buildAIDiscoveryPrompt(mode, ctx) {
    ...
    if (mode === 'contacts') {
        ...
        return [
            ...
            '- U s.r.o. / a.s. je nejbezpečnější ověřená osoba JEDNATEL z obchodního rejstříku. Pokud znáš IČO, preferuj jednatele zapsaného v rejstříku.',
            '- IČO MUSÍ patřit přesně té firmě, kterou uvádíš — zkontroluj, že u toho IČO v rejstříku sedí název I sídlo. Nikdy nepřiřazuj náhodné nebo podobné IČO.',
